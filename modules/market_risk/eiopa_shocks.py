...
from utils import get_inwards_folder, add_attributes_to_html_table


EIOPA_SHOCK_FILE_PATH = os.path.join(get_inwards_folder(),
                                     'modules',
                                     'aux_files',
                                     'eiopa_shocks.csv')
...
class EIOPAShocks:
    ...
    def plot_shocks(self, for_html_report: bool = False) -> None:
    ...
    def get_shocks_by_date(self, for_html_report: bool = False):
        df = self.shocks.copy()
